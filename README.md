...
<a href="https://www.loom.com/share/31e9f68eb97e47568fc309787f2b779d">
...
- [x] Build the **`NutritionForm`** component to:
  ...
  - [x] After the form has been successfully submitted:
    - [x] X Ensure that the new nutrition entry is stored in the `nutrition` context's `nutritions` array and is displayed in the `NutritionFeed` component
